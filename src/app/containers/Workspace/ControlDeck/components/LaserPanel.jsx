  ...
  >
    ...
    <div className={styles.laserMode}>
      ...
      <button
        ...
        onClick={() => onSetLaserMode('engrave')}
      >
        {i18n._('Engrave')}
      </button>
      <button
      ...
      <button type="button" disabled={!canClick} onClick={() => onLaserTest(true)}>
    ...
    <div className={styles.presetRow}>
      ...
      <button type="button" disabled={!canClick} onClick={() => onLaserTest(false)}>
